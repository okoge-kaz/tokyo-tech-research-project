...
public class TSRexNJggM {
	 ...
	 * @param trialNo 試行番号．ログテーブルのラベルに使われる．
	 */
	private static void executeOneTrial(TSRexNJgg ga, long maxEvals, TCTable log, String trialName, int trialNo) {
	...
	public static void main(String[] args) throws IOException {
		...
		double min = +1.00; //初期化領域の最小値
		double max = +5.00; //初期化領域の最大値
		long maxEvals = (long)(4 * dimension * 1e4); //打ち切り評価回数
		int maxTrials = 3; //試行数
		String trialName = "RexJggOffsetKTabletP14K5"; //試行名
